...
//        ROS_INFO("MAX_a unreachable");
        std::cout<<"MAX_a unreachable"<<std::endl;
...
//            return 1;
        ...
        std::cout<<"MAX_v unreachable"<<std::endl;
        duration_vmax = 0;
        _max_a = max_a_given;
        float alpha = 1.0f/_max_a;
        float betta = _max_a/_max_j;
        float gamma = -_len;//!!!!! minus
        float root_ = betta * betta - 4*alpha*gamma;
        _max_v = (-betta + sqrt(root_))/2/alpha;
